...
function WatchMovie() {
    ...
    return (  
        <div className="w-full h-full bg-[#161616]">
            ...
            {
                trailer && (
                    <div className="w-full h-auto md:px-[15rem]">
                        ...
                        <div className="w-full md:w-[75%] h-[70rem] md:px-0 px-[1.5rem]">
                            ...
                            <div className="text-white text-[1.4rem] md:text-[1.8rem] font-semibold mt-[2rem]">
                                Bình luận(<span>10</span>)
                            </div>
                            <div className="relative flex items-start mt-[2rem]">
                                <div className="w-[4rem] h-[4rem] md:w-[5rem] md:h-[5rem] rounded-[50%] border-[.1rem]">
                                    <img
                                ...
                                <textarea placeholder="Viết bình luận của bạn..." maxLength={200} className="w-[calc(100%-5rem)] h-[5rem] md:h-[8rem] pt-3 pl-[1.5rem] bg-[transparent] border-[.1rem] border-[#565656] text-white ml-4 resize-none outline-none focus:border-[#00d9ff]">
                                </textarea>
                                <div className="absolute bottom-1 right-2 text-[1.2rem] text-white"> 
                                    <span>0</span>/200
                                </div>
                                <div className="absolute -bottom-[3rem] md:-bottom-[4rem] right-0 text-[1.4rem] md:text-[1.6rem]">
                                    <span className="px-4 py-1 md:px-8 md:py-3 text-white bg-[red] mr-4 rounded-[.4rem] hover:opacity-[.8] cursor-pointer transition-all duration-[.25s]">Hủy</span>
                                    <span className="px-4 py-1 md:px-8 md:py-3 text-white bg-primary rounded-[.4rem] hover:opacity-[.8] cursor-pointer transition-all duration-[.25s]">Đăng</span>
                                </div>
                            </div>
                        </div>
                    </div>
